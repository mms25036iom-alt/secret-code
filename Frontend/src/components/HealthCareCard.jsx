  ...
  useEffect(() => {
    ...
    speechRecognition.onresult = (event) => {
      ...
      if (transcript.includes("telemedicine")) {
        ...
        window.open('https://Cureon-maps-client.vercel.app/', '_blank');
      }
    };
  ...
  return (
    <div style={responsiveStyles.container}>
      ...
      <div style={responsiveStyles.cardsContainer}>
        ...
        {(user?.role === 'doctor' || user?.role === 'user' || !user) && (
          <div
        ...
        {/* Consult - For Doctors and Patients */}
        {(user?.role === 'doctor' || user?.role === 'user' || !user) && (
          <div
            className="bg-blue-100 shadow-lg rounded-xl text-center p-8 hover:shadow-xl transform transition-all duration-300 hover:-translate-y-1"
        ...
        <div
          ...
          onClick={() => {
            console.log('Emergency card clicked - opening Cureon Maps');
            window.open('https://Cureon-maps-client.vercel.app/', '_blank');
          }}
        ...
        {/* Health Watch - For Patients only */}
        {(user?.role === 'user' || !user) && (
          <div
            className="bg-blue-100 shadow-lg rounded-xl text-center p-8 hover:shadow-xl transform transition-all duration-300 hover:-translate-y-1"
