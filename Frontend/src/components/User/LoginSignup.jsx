...
const LoginSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (authMode === "login") {
      // Login validation - only need contact and password
      if (!formData.contact || !formData.password) {
        alert('Please enter email/phone and password');
        return;
      }
      
      console.log('🔐 Attempting login with:', formData.contact);
      dispatch(login(formData.contact, formData.password));
    } else {
      // Signup validation - need all fields
      ...
      // Ensure role is set correctly before registration
  ...
  useEffect(() => {
    if (authMode === "signup") {
      setRole("user"); // Reset to user/patient when opening signup
    }
  }, [authMode]);
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <span
                          className={`text-center ${
                            role === "user" ? "text-black" : "text-blue-100"
                          }`}
                        >
                          Patient
                        </span>
                      ...
                      >
                        <input
                          ...
                          checked={role === "doctor"}
                          onChange={(e) => {
                            console.log('👨‍⚕️ Doctor role selected');
                            setRole("doctor");
                          }}
                          className="sr-only" // Hide the actual radio button
                        />
                      ...
                      >
                        <input
                          ...
                          onChange={(e) => {
                            console.log('💊 Pharmacist role selected');
                            setRole("pharmacist");
                          }}
                          className="sr-only"
                        />
