...
function ECGAnalysisModal({ isOpen, onClose }) {
    ...
    const cardContainerVariants = {
        ...
        visible: {
            opacity: 1,
            transition: { delay: 0.3, staggerChildren: 0.15, delayChildren: 0.1 }
        }
    };
    ...
    const cardVariants = {
        ...
        visible: { 
            ...
            transition: { duration: 0.4, ease: "easeOut", type: "spring", damping: 20 }
        },
    ...
    const iconVariants = {
        ...
        visible: { scale: 1, rotate: 0, transition: { delay: 0.2, duration: 0.3, ease: "easeOut" } },
    ...
    const heartbeatVariants = {
        heartbeat: { scale: [1, 1.2, 1, 1.1, 1], transition: { duration: 1.5, repeat: Infinity, ease: "easeInOut" } }
    };

    const floatingVariants = {
        float: { y: [-2, 2, -2], transition: { duration: 3, repeat: Infinity, ease: "easeInOut" } }
    };
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            {/* --- NEW: Heart Health Insights Section --- */}
                            <motion.div
                                className="mt-8 bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 border border-gray-100 shadow-inner"
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: 0.7, duration: 0.4 }}
                            >
                                <motion.h4 
                                    className="text-md font-semibold text-gray-700 mb-3 flex items-center justify-center gap-2"
                                    initial={{ opacity: 0, y: 10 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ delay: 0.8 }}
                                >
                                    ❤️ Heart Health Insights
                                </motion.h4>
                                    ...
                                    {[
                                        {
                                            ...
                                            text: "Regular ECG checkups help detect irregular heart rhythms early."
                                        },
                                        {
                                            icon: <Activity className="w-4 h-4 text-emerald-500" />,
                                            text: "A balanced diet and regular exercise strengthen your heart muscles."
                                        },
                                        {
                                            icon: <Zap className="w-4 h-4 text-yellow-500" />,
                                            text: "Manage stress levels — meditation and sleep are vital for cardiac health."
                                        }
                                    ].map((tip, index) => (
                                        <motion.li
                                            key={index}
                                            className="flex items-start gap-3 p-3 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all"
                                            variants={{
                                        ...
                                        >
                                            ...
                                            <p className="flex-1 leading-snug">{tip.text}</p>
                                        </motion.li>
                                    ))}
                                </motion.ul>
                            </motion.div>
