...
export default function Retinopathy() {
    ...
    const analyzeImage = async (imageUrl) => {
        try {
            ...
            const text = await analyzeMedicalImage(base64Image, 'retinopathy');
            setAnalysis(text);
    ...
    const generatePDF = () => {
        ...
        try {
            ...
            doc.text("Cureon - Retinopathy Scan Analysis Report", pageWidth / 2, 20, { align: 'center' });
        ...
        <div className="min-h-screen bg-blue-50">
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="flex items-center justify-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800 ml-2">Cureon AI Assistant</h1>
                </div>
