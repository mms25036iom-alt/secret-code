...
function AnalysisBotECG() {
    ...
    const analyzeImage = async (imageUrl) => {
        ...
        try {
            ...
            const errorMessage = error.message || 'Error processing the image.';
            setAnalysis(`❌ **Analysis Error**\n\n${errorMessage}\n\n**Troubleshooting:**\n- Ensure the ECG analysis server is running on port 8001\n- Check your internet connection\n- Try uploading a different image\n- Contact support if the issue persists`);
        } finally {
    ...
    const generatePDF = () => {
        ...
        try {
            ...
            doc.text("Cureon - ECG Analysis Report", pageWidth / 2, 20, { align: 'center' });
