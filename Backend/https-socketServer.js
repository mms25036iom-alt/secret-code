...
const PORT = process.env.SOCKET_HTTPS_PORT || 5001;
server.listen(PORT, () => {
  console.log(`🔒 HTTPS Socket.IO signaling server running on port ${PORT}`);
  console.log(`📡 Ready to handle secure video call connections`);
